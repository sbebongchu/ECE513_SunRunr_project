function sendSigninRequest() {
    ...
    $.ajax({
            url: 'http://ec2-18-223-182-143.us-east-2.compute.amazonaws.com:3000/users/signin',
            type: 'POST',
...
function signinSuccess(data, textSatus, jqXHR) {
    ...
    window.location = "http://ec2-18-223-182-143.us-east-2.compute.amazonaws.com:3000/account.html";
}
